...
export default function SidebarLayout() {
  ...
  const user = { name: 'John Doe', avatar: 'https://i.pravatar.cc/40' };
          ...
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg z-10">
                <Link to="/dashboard" onClick={() => {setDropdownOpen(false);}} className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                  Profile
                </Link>
                <button
