    ...
    <div className="flex flex-col h-full">
      ...
      <main className="p-6 bg-gray-100 flex-1 overflow-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="relative bg-blue-500 text-white rounded-lg p-6 shadow hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
            <HiCube className="absolute right-4 top-4 text-white opacity-20 text-6xl pointer-events-none" />
            <p className="text-sm uppercase">Total Inventories</p>
